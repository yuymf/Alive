...
- **文件:** `~/.openclaw/workspace/memory/minase/diary.md`
...
- **文件:** `~/.openclaw/workspace/memory/minase/relations/{user_id}.json`
- **格式:** JSON，结构化
- **保留:** 最近 90 天的事件
...
- **文件:** `~/.openclaw/workspace/memory/minase/core-wisdom.json`
- **永久保留**
