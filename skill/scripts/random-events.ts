...
const EVENT_POOL: RandomEventDef[] = [
    ...
    chain_events: [
      {
        ...
        diary_entry: '那件合作的事一直在脑子里转...算了我值这个价，不接就不接',
      },
      {
        description: '睡前还在想',
        probability: 0.3,
        ...
        diary_entry: '躺在床上又开始想白天那件事了...烦死了，不想了不想了',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    intent_boosts: [{ category: '休息', boost: 1.0 }],
    diary_entry: '住的地方楼下又在装修了...好吵啊根本没法集中注意力，要不要换个民宿',
    preconditions: {},
    weight_modifiers: {},
  },
