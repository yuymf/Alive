...
vi.mock('../scripts/engines/vitality', () => ({
...
import { readJSON, writeJSON, appendText, readTemplate } from '../scripts/utils/file-utils';
import { callLLM } from '../scripts/utils/llm-client';
import { exaWebSearch } from '../scripts/utils/exa-client';
import { applyActionCost } from '../scripts/engines/vitality';
