...
// Inject travel city getter after importing
import { setTravelCityGetter } from '../sub-skills/platform/generate-image/scripts/prompt-builder';
setTravelCityGetter(() => '東京，日本');
...
import {
  ...
  styleContext,
  type ImageEntry,
} from '../sub-skills/platform/generate-image/scripts/prompt-builder';
